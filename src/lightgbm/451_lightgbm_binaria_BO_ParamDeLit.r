...
PARAM$experimento <- "HT4510_FreeStyle"
...
hs <- makeParamSet(
  ...
  makeIntegerParam("max_depth", lower = 3L, upper = 12L),  ################# FREeSTYLE
  makeIntegerParam("lambda_l1", lower = 0L, upper = 100L),  ################# FREeSTYLE
  makeIntegerParam("lambda_l2", lower = 0L, upper = 100L),  ################# FREeSTYLE
  makeIntegerParam("min_gain_to_split", lower = 0L, upper = 100L),  ################# FREeSTYLE
  makeIntegerParam("min_data_in_leaf", lower = 100L, upper = 15000L), ################# FREeSTYLE
  makeIntegerParam("num_leaves", lower = 20L, upper = 3000L), ################# FREeSTYLE
  makeNumericParam("feature_fraction", lower = 0.4, upper = 1), ################# FREeSTYLE
  makeNumericParam("bagging_fraction", lower = 0.4, upper = 1), ################# FREeSTYLE
  makeIntegerParam("bagging_freq", lower = 1L, upper = 7L), ################# FREeSTYLE
