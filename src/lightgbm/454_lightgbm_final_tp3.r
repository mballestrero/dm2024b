...
PARAM$finalmodel$num_iterations <-  1368 

PARAM$finalmodel$learning_rate <-  0.0100150180104755 

PARAM$finalmodel$feature_fraction <-  0.406731651772865 

PARAM$finalmodel$min_data_in_leaf <-  1705 

PARAM$finalmodel$num_leaves <-  744 
